...
/**
 * Interface that exposes the framework's AbstractGarbage Processor's members. StrategyCollectors passed to the framework should implement this
 * interface.
 */
public interface StrategyHolder {
     ...
     * and their corresponding AbstractGarbage Disposal Strategies.
     ...
     * @param strategy The corresponding AbstractGarbage Disposal Strategy that will be mapped to the annotationClass in case of success.
