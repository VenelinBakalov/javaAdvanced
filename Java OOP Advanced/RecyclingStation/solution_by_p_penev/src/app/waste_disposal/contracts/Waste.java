...
/**
 * Interface that AbstractGarbage objects should implement. AbstractGarbage objects for processing passed to the framework should implement this interface.
 */
